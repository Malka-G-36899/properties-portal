...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"F:\\תיקייה כללית חדש\\שנה ב תשפה\\קבוצה א\\תלמידות\\malky & batya project\\project\\server\\DAL\\data\\data_base.mdf\";Integrated Security=True;Connect Timeout=30;Integrated Security=True;Connect Timeout=30");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CustomerName, e.CustomerPassword }, "IX_customers_Column");
            ...
            entity.HasMany(d => d.Properties).WithMany(p => p.Customers)
                .UsingEntity<Dictionary<string, object>>(
                    "FavoriteProperty",
                    r => r.HasOne<PropertyForSale>().WithMany()
                        .HasForeignKey("PropertyId")
                        .HasConstraintName("FK__favorite___prope__5BE2A6F2"),
        ...
        modelBuilder.Entity<PropertyForSale>(entity =>
        {
            ...
            entity.HasOne(d => d.Sells).WithMany(p => p.PropertyForSales)
                ...
                .HasConstraintName("FK__property___sells__5AEE82B9");
        });
